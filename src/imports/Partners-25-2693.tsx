import svgPaths from "./svg-wzivslf5ql";
...
function Partners() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="Partners">
      <p className="absolute font-['Saira_SemiCondensed:Regular',_sans-serif] leading-[48px] left-[384.23px] not-italic text-[48px] text-center text-nowrap text-white top-0 translate-x-[-50%] whitespace-pre">Socios Aliados</p>
    </div>
  );
}
...
function Container9() {
  return (
    <div className="h-[137px] relative shrink-0 w-full" data-name="Container">
      <div className="h-[137px] overflow-clip relative rounded-[inherit] w-full">
        <Partners4 />
        <p className="absolute font-['Montserrat:Regular',_sans-serif] leading-[32px] left-[24px] not-italic text-[24px] text-nowrap text-white top-[48px] whitespace-pre">Chile</p>
      </div>
      <div aria-hidden="true" className="absolute border-[0px_0px_1px] border-[rgba(255,255,255,0.1)] border-solid inset-0 pointer-events-none" />
    </div>
  );
...
function Heading3() {
  return (
    <div className="absolute h-[28px] left-[28px] top-0 w-[181.906px]" data-name="Heading 4">
      <p className="absolute font-['Montserrat:Bold',_sans-serif] leading-[28px] left-0 not-italic text-[20px] text-nowrap text-white top-0 whitespace-pre">Grupo GB | CINCO</p>
    </div>
  );
}
...
function Text1() {
  return (
    <div className="absolute h-[20px] left-[30px] top-0 w-[129.297px]" data-name="Text">
      <p className="absolute font-['Montserrat:Regular',_sans-serif] leading-[20px] left-0 not-italic text-[14px] text-[rgba(255,255,255,0.7)] text-nowrap top-0 whitespace-pre">La Reina, Santiago</p>
    </div>
  );
}
...
function Paragraph2() {
  return (
    <div className="h-[27.188px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Montserrat:Regular',_sans-serif] leading-[27.2px] left-0 not-italic text-[16px] text-[rgba(255,255,255,0.7)] text-nowrap top-px whitespace-pre">(+56-2) 2 209 33 19</p>
    </div>
  );
}
...
function Paragraph3() {
  return (
    <div className="h-[27.188px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Montserrat:Regular',_sans-serif] leading-[27.2px] left-0 not-italic text-[16px] text-[rgba(255,255,255,0.6)] text-nowrap top-px whitespace-pre">(+56-9) 9 329 35 78</p>
    </div>
  );
}
...
function Link1() {
  return (
    <div className="absolute h-[20px] left-[30px] top-0 w-[277.594px]" data-name="Link">
      <p className="absolute font-['Montserrat:Regular',_sans-serif] leading-[20px] left-0 not-italic text-[14px] text-[rgba(255,255,255,0.7)] text-nowrap top-0 whitespace-pre">contacto.chile@geoperuviangroup.com</p>
    </div>
  );
}
...
function Heading4() {
  return (
    <div className="absolute h-[32px] left-[24px] top-[48px] w-[120.281px]" data-name="Heading 3">
      <p className="absolute font-['Montserrat:Regular',_sans-serif] leading-[32px] left-0 not-italic text-[24px] text-nowrap text-white top-[-1px] whitespace-pre">Argentina</p>
    </div>
  );
}
...
function Heading5() {
  return (
    <div className="h-[28px] relative shrink-0 w-full" data-name="Heading 4">
      <p className="absolute font-['Montserrat:Bold',_sans-serif] leading-[28px] left-0 not-italic text-[20px] text-nowrap text-white top-0 whitespace-pre">Newensa S.A.</p>
    </div>
  );
}
...
function Paragraph4() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Montserrat:Regular',_sans-serif] leading-[20px] left-0 not-italic text-[14px] text-[rgba(255,255,255,0.6)] text-nowrap top-0 whitespace-pre">Consultoría Especializada</p>
    </div>
  );
}
...
function Text2() {
  return (
    <div className="absolute h-[20px] left-[30px] top-0 w-[138.469px]" data-name="Text">
      <p className="absolute font-['Montserrat:Regular',_sans-serif] leading-[20px] left-0 not-italic text-[14px] text-[rgba(255,255,255,0.7)] text-nowrap top-0 whitespace-pre">Las Heras, Mendoza</p>
    </div>
  );
}
...
function Paragraph5() {
  return (
    <div className="h-[27.188px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Montserrat:Regular',_sans-serif] leading-[27.2px] left-0 not-italic text-[16px] text-[rgba(255,255,255,0.7)] text-nowrap top-px whitespace-pre">(+54-0261) 4236300</p>
    </div>
  );
}
...
function Paragraph6() {
  return (
    <div className="h-[27.188px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Montserrat:Regular',_sans-serif] leading-[27.2px] left-0 not-italic text-[16px] text-[rgba(255,255,255,0.6)] text-nowrap top-px whitespace-pre">(+54-9) 2615 51 5666</p>
    </div>
  );
}
...
function Link2() {
  return (
    <div className="absolute h-[40px] left-[30px] top-0 w-[304px]" data-name="Link">
      <p className="absolute font-['Montserrat:Regular',_sans-serif] leading-[20px] left-0 not-italic text-[14px] text-[rgba(255,255,255,0.7)] top-0 w-[299px]">contacto.argentina@geoperuviangroup.com</p>
    </div>
  );
}
  ...
  return (
    <div className="h-[32px] relative shrink-0 w-[229.812px]" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[32px] relative w-[229.812px]">
        <p className="absolute font-['Montserrat:Regular',_sans-serif] leading-[32px] left-[115px] not-italic text-[24px] text-center text-nowrap text-white top-[-1px] translate-x-[-50%] whitespace-pre">Presencia Regional</p>
      </div>
    </div>
  );
}
